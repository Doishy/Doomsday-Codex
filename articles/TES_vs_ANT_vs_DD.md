...
This point feeds into some of his later comments:
...
you spend to look is actually a costing a full card now."
```
...
For this comparison I will be using data taken from two spreadsheets linked by an article
...
or so gobbos can lead to fast wins. 

When discussing this point with Nanda he made the following comments:
...
```
"...we're playing a faster Storm deck with pet cards instead of the cards that make it a consistently fast threat..."
```
is true.
...
is still closer to TES in speed than ANT and is still faster than ANT despite also relying
...
I guess that paints a clear picture. The four engines measured are the two primary ones of 
